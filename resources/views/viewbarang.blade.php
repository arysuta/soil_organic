			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3 text-center animate-box intro-heading">
						...
						<h3>Category : {{$kategoris->kategori}}</h3>
				...
				@foreach ($barangs as $barang)
					<div class="col-md-4 animate-box">
						<div class="dish-wrap">
							<p class="price"><span>idr {{$barang->harga}}</span></p>
							<div class="addtocart">
								<div class="dis-tc">
									<span><a href="{{route('Main.detail', ['id' => $barang->id])}}"><i class="icon-search3"></i></a></span>
								</div>
							</div>
							<div class="wrap">
								@if(count($barang->Detgambar) > 0)
									<div class="dish-img" style="background-image: url(/files/{{$barang->detgambar[0]->nama_gambar}});"></div>
									
								@else
									<div class="dish-img" style="background-image: url(/default_img/img_bg_2.jpg);"></div>
									
								@endif
								<div class="desc">
									<h2><a href="#">{{$barang->nama_barang}}</a></h2>
								</div>
							</div>
						</div>
					</div>
